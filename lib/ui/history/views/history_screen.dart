      ...
      builder: (logic) {
        return TableCalendar(
          ...
          selectedDayPredicate: (day) {
            if (day ==
                DateTime.parse(
                    "${DateTime.parse(DateTime.now().toString().split(" ")[0])}Z")) {
              return false;
            } else {
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: AppSizes.height_0_8),
                      Text(
                        "${historyWeekDataList.totKcal!.toStringAsFixed(2)} ${"txtKcal".tr}",
                        textAlign: TextAlign.left,
                        style: TextStyle(
                          color: AppColor.txtColor666,
                          fontSize: AppFontSize.size_9,
                                ...
                                children: [
                                  ...
                                  Container(
                                    margin: EdgeInsets.only(
                                        ...
                                        right: AppSizes.width_4),
                                    child: Text(
                                     "${double.parse(arrHistoryDetail[index].hBurnKcal!).toStringAsFixed(2)} ${"txtKcal".tr}",
                                      textAlign: TextAlign.left,
                                      style: TextStyle(
                                        color: AppColor.txtColor666,
                                        fontSize: AppFontSize.size_9,
